...
This package serves to simulate the joint distribution of empirical patient-level data based on the copula invariance property.
...
- To increase the data variability, we suggest that the data validation option should be turned off. That is, the argument for validation.type should be set to "none". 
...
## Employ function *new.arm.copula.sim* to simulate new multivariate datasets with shifted mean vector from existing empirical data. This function assumes that the dependence structure of the new-arm data and that of the empirical data are the same.
...
- CRAN page: https://cran.r-project.org/web/packages/copulaSim/index.html
